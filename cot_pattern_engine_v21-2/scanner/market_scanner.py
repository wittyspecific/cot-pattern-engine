...
def top_five_clusters(
    ...
    columns = [
        ...
        "Cluster Richtungsanteil", "Cluster Median", "Cluster Beginnfenster", "COT-Stichtag"
    ]
...
def top_five_cot_index(
    ...
    columns = [
        "Asset", "Kategorie", "Commercial COT Index", "Retail COT Index",
        "Index Fälle", "Index Gestiegen", "Index Gefallen", "Index Richtungsanteil",
        "Index Median", "Index Beginnfenster", "COT-Stichtag"
    ]
    return valid.sort_values(
